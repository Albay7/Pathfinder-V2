    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <div class="w-full bg-gray-200 rounded-full h-2">
                <div class="bg-purple-600 h-2 rounded-full transition-all duration-300" id="progress-bar" style="width: 10%"></div>
            </div>
        </div>
        ...
        <form id="mbti-questionnaire-form" action="{{ route('pathfinder.mbti-questionnaire.process') }}" method="POST" class="space-y-8">
            ...
            <div class="flex justify-between items-center mt-12">
                ...
                <button type="button" id="next-btn" class="px-6 py-3 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                    Next
                </button>
...
<style>
    ...
    /* Enhanced selected state for purple options */
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            values.forEach((value, index) => {
                ...
                optionsHTML += `
                    <label for="q${questionNum}_${value}" class="cursor-pointer block mx-2">
                        ...
                        <div class="modern-radio-option ${sizes[index]} rounded-xl bg-gradient-to-br from-${colorClass}-50 to-${colorClass}-100 border-2 border-${colorClass}-200 hover:border-${colorClass}-400 ${shadowClass} transform hover:scale-105 transition-all duration-300 flex items-center justify-center group" data-value="${value}">
                            <div class="${innerSizes[index]} rounded-full bg-gradient-to-br from-${colorClass}-400 to-${colorClass}-600 opacity-0 group-hover:opacity-30 transition-all duration-300 flex items-center justify-center">
        ...
        function checkEarlyCompletion() {
            // Only allow early completion in standard mode and after at least 30 questions
            if (adaptiveMode || Object.keys(responses).length < 30) {
                return false;
            }
