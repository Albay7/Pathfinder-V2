...
<div class="bg-gradient-to-br from-purple-600 to-indigo-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center">
            ...
            @if($personalityType)
                <h2 class="text-2xl font-semibold text-purple-200 mb-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Strengths -->
                <div class="bg-green-50 rounded-xl shadow-lg border border-green-200 p-8">
                ...
                <!-- Areas for Growth -->
                <div class="bg-blue-50 rounded-xl shadow-lg border border-blue-200 p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div class="bg-gray-50 rounded-xl shadow-lg border border-gray-200 p-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-4">
                        <div class="bg-blue-600 h-4 rounded-l-full" style="width: {{ $mbtiScores['E_I']['E'] }}%"></div>
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-4">
                        <div class="bg-purple-600 h-4 rounded-l-full" style="width: {{ $mbtiScores['J_P']['J'] }}%"></div>
                    </div>
                    <div class="flex justify-between mt-1 text-sm text-gray-600">
            ...
            <div class="bg-gray-50 rounded-xl shadow-lg border border-gray-200 p-8">
                ...
                <h3 class="text-xl font-semibold text-indigo-700 mb-3">{{ $learningStyle['style'] }}</h3>
...
<div class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl shadow-lg border border-indigo-200 p-8 mb-8">
            ...
            <div class="bg-white rounded-lg p-4 border-l-4 border-indigo-500">
                <p class="text-sm text-indigo-700 font-medium">
                    💡 <strong>Pro Tip:</strong> The careers below are specifically curated based on your {{ $mbtiType }} personality traits and have high compatibility scores with your natural strengths and preferences.
                </p>
            </div>
        </div>
        @endif
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            <a href="{{ route('pathfinder.career.details', ['career' => urlencode($career)]) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors duration-200">
                                Explore Career
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <a href="{{ $course['url'] }}" target="_blank" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium">
                                View Course
                                <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @foreach($jobRecommendations as $job)
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <a href="{{ $job['url'] }}" target="_blank" class="inline-flex items-center text-purple-600 hover:text-purple-800 font-medium">
                                View Job
                                <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                </svg>
...
<div class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-md p-8 text-center">
                ...
                <a href="{{ route('pathfinder.career-guidance') }}" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors duration-200">
                    View Careers
                </a>
            </div>

            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-md p-8 text-center">
                ...
                <a href="{{ route('pathfinder.external-resources') }}" class="inline-block px-6 py-3 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 transition-colors duration-200">
                    Learning Resources
                </a>
            </div>
