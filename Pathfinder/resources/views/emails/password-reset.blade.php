                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #555; font-size: 15px; line-height: 1.6; margin: 0 0 24px;">
                                We received a request to reset the password for your <strong>Pathfinder Career Guidance</strong> account. Click the button below to set a new password:
                            </p>
                            ...
                            <p style="color: #888; font-size: 13px; line-height: 1.5; margin: 0 0 16px;">
                                This link will expire in <strong>60 minutes</strong>. If you did not request a password reset, please ignore this email and your password will remain unchanged.
                            </p>

                            <p style="color: #aaa; font-size: 12px; line-height: 1.5; margin: 0;">
                                If the button doesn't work, copy and paste this URL into your browser:<br>
                                <span style="color: #5AA7C6; word-break: break-all;">{{ $resetUrl }}</span>
                            </p>
                        </td>
                    </tr>
