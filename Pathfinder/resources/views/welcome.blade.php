...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Pathfinder - Career Guidance Platform</title>
    ...
    <body class="min-h-screen bg-white">
        ...
        <!-- Hero Section -->
        <section class="bg-gradient-to-br py-24">
            <div class="max-w-7xl mx-auto px-4 text-center">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-6">
                    Discover Your Perfect Career Path
                </h1>
                <p class="text-xl text-white mb-8 max-w-3xl mx-auto">
                    Get personalized career guidance through our advanced assessment system.
                    Find courses and jobs that match your interests, skills, and aspirations.
                </p>
        ...
        <section id="features" class="py-24 bg-blue-50">
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold text-gray-900 mb-4">Why Choose Pathfinder?</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="card text-center">
                        <div class="w-16 h-16 bg-fountain-blue rounded-lg mx-auto mb-6 flex items-center justify-center">
                            <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                            </svg>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Career Assessment</h3>
                        <p class="text-gray-600">
                            Take our comprehensive questionnaire to discover courses and jobs that match your interests and skills.
                        </p>
                    </div>
                    ...
                    <div class="card text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Personalized Results</h3>
                        <p class="text-gray-600">
                            Receive tailored recommendations based on your unique profile and career goals.
                        </p>
                    </div>
                    ...
                    <div class="card text-center">
                        ...
                        <p class="text-gray-600">
                            Get recommendations for courses and resources to develop your skills and advance your career.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- CTA Section -->
        <section class="py-16 bg-gradient-to-br from-blue-zodiac to-fountain-blue">
