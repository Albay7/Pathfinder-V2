        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
            <div class="p-8">
                ...
                <div id="upload-section">
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center transition-colors duration-200" id="drop-zone" onmouseover="this.style.borderColor='#5AA7C6';" onmouseout="this.style.borderColor='#d1d5db';">
                        <div class="mb-4">
