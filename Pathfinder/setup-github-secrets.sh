...
RESOURCE_GROUP="pathfinder-rg"                # Must match the resource group in deploy-azure.sh
...
# Set AZURE_RESOURCE_GROUP secret
echo "Setting AZURE_RESOURCE_GROUP secret..."
gh secret set AZURE_RESOURCE_GROUP -b"$RESOURCE_GROUP" -R $GITHUB_REPO
